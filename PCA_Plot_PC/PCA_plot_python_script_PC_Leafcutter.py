...
# Load proportions data (tmpmerge_proportions_Pied_X_Collared.txt)
proportions_file = "/home/sfadi/Bureau/PCA_Plot_PC/tmpmerge_proportions.txt"
...
plt.title('Principal Component Analysis of Intron Usage in Flycatcher Species Across Different Tissues', fontsize=20)
