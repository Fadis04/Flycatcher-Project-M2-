#!/bin/bash
#SBATCH --job-name=SRR9617546_Aligned.sortedByCoord.out.bam_JunctionExtraction
#SBATCH --nodes=1
#SBATCH --time=01:00:00
#SBATCH --partition=normal
#SBATCH --ntasks=1
#SBATCH --mem=1GB
#SBATCH --output=/beegfs/home/fslimi/scripts/Sc_fic_alb_junc/SRR9617546_Aligned.sortedByCoord.out.bam_%j_Junc.out
#SBATCH --error=/beegfs/home/fslimi/scripts/Sc_fic_alb_junc/SRR9617546_Aligned.sortedByCoord.out.bam_%j_Junc.err
...
bamfile="SRR9617546_Aligned.sortedByCoord.out.bam"
