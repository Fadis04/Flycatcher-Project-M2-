#!/bin/bash
#SBATCH --job-name=Sample_HYB05-Testis-L_Aligned.sortedByCoord.out.bam_JunctionExtraction
#SBATCH --nodes=1
#SBATCH --time=01:00:00
#SBATCH --partition=normal
#SBATCH --ntasks=1
#SBATCH --mem=1GB
#SBATCH --output=/beegfs/home/fslimi/scripts/Sc_f1_hyb_junc/junc_out-err/Sample_HYB05-Testis-L_Aligned.sortedByCoord.out.bam_%j_Junc.out
#SBATCH --error=/beegfs/home/fslimi/scripts/Sc_f1_hyb_junc/junc_out-err/Sample_HYB05-Testis-L_Aligned.sortedByCoord.out.bam_%j_Junc.err

# Define the directory containing the BAM file
bam_dir="/beegfs/data/fslimi/fic_bam/f1_hyb_bam/"

# Define the output directory for junction files
output_dir="/beegfs/data/fslimi/fic_junc/f1_hyb_junc/"

# Define the name of the BAM file to test
bamfile="Sample_HYB05-Testis-L_Aligned.sortedByCoord.out.bam"
