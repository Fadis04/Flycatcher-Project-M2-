...
metadata_file = "/home/sfadi/Bureau/PCA_plot_Tissues/Heart_grp_file"
...
# Filter metadata for heart tissue
metadata_heart = metadata[metadata['Tissue'] == 'Heart']
...
filtered_metadata = pd.DataFrame(columns=metadata_heart.columns)

for species, count in species_count.items():
    species_subset = metadata_heart[metadata_heart['Species'] == species].head(count)
...
plt.title('PCA Plot: Exon Usage Variation in Heart Tissue', fontsize=20)
