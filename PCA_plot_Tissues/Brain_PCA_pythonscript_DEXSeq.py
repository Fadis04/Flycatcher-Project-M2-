...
metadata_file = "/home/sfadi/Bureau/PCA_plot_Tissues/Brain_grp_file"
...
# Filter metadata for brain tissue
metadata_brain = metadata[metadata['Tissue'] == 'Brain']
...
filtered_metadata = pd.DataFrame(columns=metadata_brain.columns)

for species, count in species_count.items():
    species_subset = metadata_brain[metadata_brain['Species'] == species].head(count)
...
plt.title('PCA Plot: Exon Usage Variation in Brain Tissue', fontsize=20)
