...
metadata_file = "/home/sfadi/Bureau/PCA_plot_Tissues/Kidney_grp_file"
...
# Filter metadata for Kidney tissue
metadata_kidney = metadata[metadata['Tissue'] == 'Kidney']
...
filtered_metadata = pd.DataFrame(columns=metadata_kidney.columns)

for species, count in species_count.items():
    species_subset = metadata_kidney[metadata_kidney['Species'] == species].head(count)
...
plt.title('PCA Plot: Exon Usage Variation in Kidney Tissue', fontsize=20)
