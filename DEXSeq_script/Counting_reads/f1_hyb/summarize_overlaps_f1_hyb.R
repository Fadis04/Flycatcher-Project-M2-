...
bam_path <- "/beegfs/data/fslimi/fic_bam/f1_hyb_bam/"
...
read_counts_f1_hyb <- assay(se)

# Save read counts to a file in the desired path
write.table(read_counts_f1_hyb , file = "/beegfs/data/fslimi/read_counts_f1_hyb.txt", sep = "\t", quote = FALSE, col.names = TRUE, row.names = TRUE)
